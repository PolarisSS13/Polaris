...
/datum/new_skill/xenobiology
	...
	name = "Xenobiology"
	desc = "You know how to work with unfamiliar alien fauna - how to approach it carefully, document its behaviors, and defend yourself from it if need be. You've worked with aliens common in your line of work, like drakes and slimes, and you can keep them happy while preventing them from mauling you to death."
...
/datum/new_skill/xenoarchaeology
	...
	desc = "You understand how to safely unearth and handle artifacts from the Anomalous Zone. You can set up and work in a digsite without smashing the things you're trying to excavate, and then figure out what those things do and how to use and store them without exposing yourself to their negative effects."

#define SKILL_TREE_LOGISTICS "logistics"

#define SKILL_LOGISTICS "logistics"
#define SKILL_CORPORATE_LAW "corporate_law"
#define SKILL_FORENSICS "forensics"
#define SKILL_INFORMATION_TECHNOLOGY "information_technology"
#define SKILL_MANAGEMENT "management"
...
/datum/new_skill/logistics
	...
	tree = SKILL_TREE_LOGISTICS
	tree_parent = TRUE

/datum/new_skill/corporate_law
	id = SKILL_CORPORATE_LAW
	name = "Corporate Law"
...
/datum/new_skill/information_technology
	id = SKILL_INFORMATION_TECHNOLOGY

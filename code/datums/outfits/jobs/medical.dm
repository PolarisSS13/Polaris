/datum/hierarchy/outfit/job/medical
	hierarchy_type = /datum/hierarchy/outfit/job/medical
...
/datum/hierarchy/outfit/job/medical/cmo
...
/datum/hierarchy/outfit/job/medical/doctor
...
/datum/hierarchy/outfit/job/medical/doctor/emergency_physician
	name = OUTFIT_JOB_NAME("Emergency Physician")
	suit = /obj/item/clothing/suit/storage/toggle/fr_jacket

/datum/hierarchy/outfit/job/medical/doctor/surgeon
	name = OUTFIT_JOB_NAME("Surgeon")
	uniform = /obj/item/clothing/under/rank/medical/scrubs
	head = /obj/item/clothing/head/surgery/blue

/datum/hierarchy/outfit/job/medical/doctor/virologist
...
/datum/hierarchy/outfit/job/medical/doctor/nurse
	name = OUTFIT_JOB_NAME("Nurse")
	suit = null

/datum/hierarchy/outfit/job/medical/doctor/nurse/pre_equip(mob/living/carbon/human/H)
	if(H.gender == FEMALE)
		if(prob(50))
...
/datum/hierarchy/outfit/job/medical/chemist
...
/datum/hierarchy/outfit/job/medical/geneticist
...
/datum/hierarchy/outfit/job/medical/psychiatrist
...
/datum/hierarchy/outfit/job/medical/psychiatrist/psychologist
	name = OUTFIT_JOB_NAME("Psychologist")
	uniform = /obj/item/clothing/under/rank/psych/turtleneck

/datum/hierarchy/outfit/job/medical/paramedic
...
/datum/hierarchy/outfit/job/medical/paramedic/emt

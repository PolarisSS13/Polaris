...
//
//	/datum/observ/proc/is_listening(var/event_source, var/datum/listener, var/proc_call)
...
//
//	/datum/observ/proc/has_listeners(var/event_source)
//		event_source: The instance which is generating events.
//
//		Returns true if the given event_source has any listeners at all, globally or to specific event sources.
//
//	/datum/observ/proc/register(var/event_source, var/datum/listener, var/proc_call)
...
//
//	/datum/observ/proc/unregister(var/event_source, var/datum/listener, var/proc_call)
...
//
//	/datum/observ/proc/register_global(var/datum/listener, var/proc_call)
...
//
//	/datum/observ/proc/unregister_global(var/datum/listener, var/proc_call)
...
//
//	/datum/observ/proc/raise_event(src, ...)
...
/datum/observ/proc/register(var/datum/event_source, var/datum/listener, var/proc_call)
	// Sanity checking.
	if (!(event_source && listener && proc_call))
		return FALSE
	if (istype(event_source, /datum/observ))
		return FALSE

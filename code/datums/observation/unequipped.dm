...
GLOBAL_DATUM_INIT(mob_unequipped_event, /datum/observ/mob_unequipped, new)

/datum/observ/mob_unequipped
	name = "Mob Unequipped"
	expected_type = /mob
...
GLOBAL_DATUM_INIT(item_unequipped_event, /datum/observ/item_unequipped, new)

/datum/observ/item_unequipped

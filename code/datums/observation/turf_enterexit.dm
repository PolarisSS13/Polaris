...
GLOBAL_DATUM_INIT(turf_entered_event, /datum/observ/turf_entered, new)
GLOBAL_DATUM_INIT(turf_exited_event, /datum/observ/turf_exited, new)

/datum/observ/turf_entered
	name = "Turf Entered"
	expected_type = /turf

/datum/observ/turf_exited
	name = "Turf Exited"
	expected_type = /turf

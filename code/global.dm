...
var/list/station_departments = list("Polluxian Treasury", "City Council", "Public Healthcare", "Emergency and Maintenance", "Research and Science", "Police", "Cargo", "Bar", "Botany", "Civilian")

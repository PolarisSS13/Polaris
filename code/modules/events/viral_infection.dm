...
datum/event/viral_infection/announce()
	...
	if (severity == EVENT_LEVEL_MAJOR || prob(60))
		command_announcement.Announce("Confirmed outbreak of level [level] biohazard aboard [station_name()]. All current residents must contain the outbreak.", "Biohazard Alert", new_sound = 'sound/AI/outbreak5.ogg')

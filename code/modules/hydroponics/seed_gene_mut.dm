/datum/seed/proc/diverge_mutate_gene(var/datum/plantgene/G, var/turf/T)
	if(!istype(G))
...
/datum/plantgene/biochem
	gene_tag = GENE_BIOCHEMISTRY

/datum/plantgene/hardiness
	gene_tag = GENE_HARDINESS

/datum/plantgene/environment
	gene_tag = GENE_ENVIRONMENT

/datum/plantgene/metabolism
	gene_tag = GENE_METABOLISM

/datum/plantgene/structure
	gene_tag = GENE_STRUCTURE

/datum/plantgene/diet
	gene_tag = GENE_DIET

/datum/plantgene/pigment
	gene_tag = GENE_PIGMENT

/datum/plantgene/output
	gene_tag = GENE_OUTPUT

/datum/plantgene/atmosphere
	gene_tag = GENE_ATMOSPHERE

/datum/plantgene/vigour
	gene_tag = GENE_VIGOUR

/datum/plantgene/fruit
	gene_tag = GENE_FRUIT

/datum/plantgene/special
	gene_tag = GENE_SPECIAL

/datum/plantgene/proc/mutate(var/datum/seed/S)
	return

/datum/plantgene/biochem/mutate(var/datum/seed/S)
	S.set_trait(TRAIT_POTENCY, S.get_trait(TRAIT_POTENCY)+rand(-20,20),200, 0)

/datum/plantgene/hardiness/mutate(var/datum/seed/S)
	if(prob(60))
...
/datum/plantgene/environment/mutate(var/datum/seed/S)
	if(prob(60))
...
/datum/plantgene/metabolism/mutate(var/datum/seed/S)
	if(prob(65))
...
/datum/plantgene/diet/mutate(var/datum/seed/S)
	if(prob(60))
...
/datum/plantgene/output/mutate(var/datum/seed/S, var/turf/T)
	if(prob(50))
...
/datum/plantgene/atmosphere/mutate(var/datum/seed/S)
	if(prob(60))
...
/datum/plantgene/vigour/mutate(var/datum/seed/S, var/turf/T)
	if(prob(65))
...
/datum/plantgene/fruit/mutate(var/datum/seed/S)
	if(prob(65))
...
/datum/plantgene/special/mutate(var/datum/seed/S)
	if(prob(65))

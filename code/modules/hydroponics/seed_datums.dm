...
/datum/seed/grapes
	...
	chems = list(/datum/reagent/nutriment = list(1,10), /datum/reagent/sugar = list(1,5), /datum/reagent/drink/juice = list(10,10))
...
/datum/seed/grapes/green
	...
	mutants = null
	chems = list(/datum/reagent/nutriment = list(1,10), /datum/reagent/kelotane = list(3,5), /datum/reagent/drink/juice = list(10,10))
...
/datum/seed/mtear
	...
	chems = list("honey" = list(1,10), /datum/reagent/kelotane = list(3,5))
	kitchen_tag = "mtear"
...
/datum/seed/telriis
	...
	chems = list(/datum/reagent/ethanol/pwine = list(1,5), /datum/reagent/nutriment = list(1,6))
...
/datum/seed/thaadra
	...
	chems = list(/datum/reagent/frostoil = list(1,5),/datum/reagent/nutriment = list(1,5))
...
/datum/seed/jurlmah
	...
	chems = list(/datum/reagent/serotrotium = list(1,5),/datum/reagent/nutriment = list(1,5))
...
/datum/seed/amauri
	...
	chems = list(/datum/reagent/toxin/zombiepowder = list(1,10),/datum/reagent/condensedcapsaicin = list(1,5), /datum/reagent/nutriment = list(1,5))
...
/datum/seed/gelthi
	...
	chems = list(/datum/reagent/soporific = list(1,5), /datum/reagent/capsaicin = list(1,5), /datum/reagent/nutriment = list(1,5))
...
/datum/seed/vale
	...
	chems = list(/datum/reagent/paracetamol = list(1,5),/datum/reagent/dexalin = list(1,2),/datum/reagent/nutriment= list(1,5))
...
/datum/seed/surik
	...
	chems = list(/datum/reagent/impedrezene = list(1,3),/datum/reagent/synaptizine = list(1,2),/datum/reagent/nutriment = list(1,5))

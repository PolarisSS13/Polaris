...
var/list/dreams = list(
	...
	"the Detective","the warden","a member of the internal affairs","a station engineer","the Janitor","the Atmospheric Technician",
	...
	"a disoriented Promethean","towers of plastic","a Gygax","a synthetic,"a Man-Machine Interface","maintenence drones", 

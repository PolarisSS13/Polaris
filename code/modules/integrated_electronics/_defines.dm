...
#define IC_DEFAULT		1 // If the circuit comes in the default circuit box.
#define IC_RESEARCH 	2 // If the circuit design will be autogenerated for RnD.
...
/obj/item/integrated_circuit
	...
	var/category_text = null // To show up on circuit printer, and perhaps other places.

...
/obj/item/projectile/process()
	...
	spawn while(src && src.loc)
		...
		update_light() //energy projectiles that glow will bring light here. Laggy as hell right now due to how lighting works, may want to comment this out if it turns ou tot be totally stupid when live

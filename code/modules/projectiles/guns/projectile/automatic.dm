...
/obj/item/weapon/gun/projectile/automatic/m116 //subobjected because otherwise i'd just be causing bloat -k22
	name = "M116 Peacekeeper"
	desc = "A Hephaestos Industries M116 Peacekeeper. Used commonly by paramilitary organizations and private security for it's low price. It feels cheap and is mostly made of plastic, and it seems to be locked to semi-auto."
	icon_state = "m16"
	item_state = "m16"
	w_class = ITEMSIZE_LARGE
	force = 10
	...
	slot_flags = SLOT_BACK
	load_method = MAGAZINE
	magazine_type = /obj/item/ammo_magazine/m545m116
	allowed_magazines = list(/obj/item/ammo_magazine/m545m116)
	firemodes = list(
		list(mode_name="semiauto",       burst=1, fire_delay=2,    move_delay=null, burst_accuracy=null, dispersion=null))

/obj/item/weapon/gun/projectile/automatic/m116/update_icon()
	..()
	icon_state = (ammo_magazine)? "m16" : "m16-empty"

/obj/item/weapon/gun/projectile/automatic/akm //subobjects don't work with alternate sprites for reasons unknown to i.
	name = "AKM-48"
	desc = "A tried and true design, recently Cybersun Industries began producing these replica AKMs to fill a niche market."
	icon_state = "akm"
	item_state = "akm"
	w_class = ITEMSIZE_LARGE
	force = 10
	...
	slot_flags = SLOT_BACK
	load_method = MAGAZINE
	magazine_type = /obj/item/ammo_magazine/m762akm48
	allowed_magazines = list(/obj/item/ammo_magazine/m762akm48)

	one_handed_penalty = 3

	firemodes = list(
		list(mode_name="semiauto",       burst=1, fire_delay=1,    move_delay=null, burst_accuracy=null, dispersion=null), //added fire delay, this is specifically a traitor weapon.
		list(mode_name="3-round bursts", burst=3, fire_delay=2, move_delay=6,    burst_accuracy=list(0,-1,-2), dispersion=list(0.0, 0.6, 0.6))
		)
/obj/item/weapon/gun/projectile/automatic/akm/update_icon()
	..()
	icon_state = (ammo_magazine)? "akm" : "akm-empty"
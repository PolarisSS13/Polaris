/obj/item/weapon/gun/projectile/caseless/prototype
	...
	desc = "A rifle cooked up in NanoTrasen's R&D labs that operates with Kraut Space Magic™ clockwork internals. Uses solid phoron propellant 5mm caseless rounds."
	icon_state = "G11"
	item_state = "G11"
	w_class = ITEMSIZE_LARGE
	caliber = "5mm caseless"
	//origin_tech = list(TECH_COMBAT = 2, TECH_MATERIAL = 2) // Haven't decided what this should be yet.

/obj/item/weapon/gun/magnetic/matfed
	...
	description_fluff = "An aging Grayson Manufactories mining tool used for rapidly digging through rock. Mass production was discontinued when multiple of the devices were stolen and used to break into a high security vault on Mars."

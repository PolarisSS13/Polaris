/decl/cultural_info/faction/skrell_kingdoms
	name = "Skrellian Kingdoms"
	description = "Allegiance to the Skrellian Kingdoms."
	subversive_potential = 1

/decl/cultural_info/faction/skrell_qerrglia
	name = "Qerr-Gila"
	description = "The Qerr-Glia have their roots in Qerr-Katish royals deposed in the last of the great wars on the Skrellian homeworld. Rather than accept disgrace as Ue-Katish, they turned to a life of crime. While the Qerr-Glia have at their disposition a very large network of relations and maintain several fragile alliances between various families, their only loyalty resides in their own family. They will temporarily hire anyone competent enough to fulfill their goals, willfully or forcefully, but only the members of the Qerr-Glia family are permanent members of a Qerr-Glia cell. Any Skrell abandoning their Qerr-Gila siblings for any reason would find themselves fiercely hunted down by their former brothers and sisters. "
	subversive_potential = 1.1 //Less known to humans?

/decl/cultural_info/faction/skrell_uekatish

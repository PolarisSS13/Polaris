...
/decl/cultural_info/location/human/alphacentauri
	name = HOME_SYSTEM_HUMAN_ACENTAURI
...
/decl/cultural_info/location/human/kessgendar
	name = HOME_SYSTEM_HUMAN_KESSGENDAR
...
/decl/cultural_info/location/human/tauceti
	name = HOME_SYSTEM_HUMAN_TAUCETI
...
/decl/cultural_info/location/human/saintcolumbia
	name = HOME_SYSTEM_HUMAN_SCOLUMBIA
...
/decl/cultural_info/location/human/terminus
	name = HOME_SYSTEM_HUMAN_TERMINUS
...
/decl/cultural_info/location/human/other
	name = HOME_SYSTEM_HUMAN_OTHER
	description = "Sometimes, whole systems can fall to the wayside in this little neighborhood we call home. Your home is one of them, under the flag of the SCG."
	economic_power = 1

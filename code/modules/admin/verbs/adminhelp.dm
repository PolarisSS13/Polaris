...
/client/verb/adminhelp(msg as text)
	...
	var/mentor_msg = "<font color='blue'> <b><font color=red>Request for Help: </font>[get_options_bar(mob, 4, 1, 1, 0)][ai_cl]:</b> [msg]</font>"
	msg = "<font color='blue'> <b><font color=red>Request for Help:: </font>[get_options_bar(mob, 2, 1, 1)][ai_cl]:</b> [msg]</font>"

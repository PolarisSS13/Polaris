...
/client/proc/cmd_admin_subtle_message(mob/M as mob in mob_list)
	...
	message_admins("<font color='blue'> \bold SubtleMessage: [key_name_admin(usr)] -> [key_name_admin(M)] : [msg]</font>", 1)
...
/client/proc/cmd_admin_world_narrate() // Allows administrators to fluff events a little easier -- TLE
	...
	message_admins("<font color='blue'> \bold GlobalNarrate: [key_name_admin(usr)] : [msg]<BR></font>", 1)
...
/client/proc/cmd_admin_direct_narrate(var/mob/M)	// Targetted narrate -- TLE
	...
	message_admins("<font color='blue'> \bold DirectNarrate: [key_name(usr)] to ([M.name]/[M.key]): [msg]<BR></font>", 1)
	...
	for(var/mob/living/silicon/ai/M in mob_list)
		if (M.stat == 2)
			...
			for(var/mob/living/silicon/ai/O in mob_list)
				O << "<font color='red'> </font>" + input + "<font color='red'>...LAWS UPDATED</font>"
				O.show_laws()

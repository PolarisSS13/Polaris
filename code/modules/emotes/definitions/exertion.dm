/datum/emote/exertion/biological
	key = "esweat"
	emote_range = 4
	emote_message_1p = "You are sweating heavily."
	emote_message_3p = "is sweating heavily."

/datum/emote/exertion/biological/check_user(mob/living/user)
	if(istype(user) && !user.isSynthetic())
		return ..()
	return FALSE

/datum/emote/exertion/biological/breath
	key = "ebreath"
	emote_message_1p = "You feel out of breath."
	emote_message_3p = "looks out of breath."

/datum/emote/exertion/biological/pant
	key = "epant"
	emote_range = 3
...
/datum/emote/exertion/synthetic
	key = "ewhine"
	emote_range = 3
	message_type = AUDIBLE_MESSAGE
...
/datum/emote/exertion/synthetic/check_user(mob/living/user)
	if(istype(user) && user.isSynthetic())
		return ..()
	return FALSE

/datum/emote/exertion/synthetic/creak
	key = "ecreak"

...
/datum/event2/event/wildlife_encounter/proc/item_to_spawn()
	return pick(prob(22);/mob/living/simple_mob/animal/sif/savik,
				...
				prob(5);/mob/living/simple_mob/animal/giant_spider,
				prob(7);/mob/living/simple_mob/animal/giant_spider/hunter,
				prob(4);/mob/living/simple_mob/animal/giant_spider/webslinger,
				prob(4);/mob/living/simple_mob/animal/giant_spider/carrier,
				...
				prob(5);/mob/living/simple_mob/animal/giant_spider/electric,

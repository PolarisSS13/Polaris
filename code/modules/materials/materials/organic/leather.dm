...
/datum/material/leather/generate_recipes()
	recipes = list(
		...
		new /datum/stack_recipe("hide oversuit", /obj/item/clothing/suit/storage/hooded/wintercoat/hidesuit, 10, time = 15 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]")
	)

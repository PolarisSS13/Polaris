/client/proc/spawn_chemdisp_cartridge(size in list("small", "medium", "large"), reagent in SSchemistry.chemical_reagents_list)
	...
	var/datum/reagent/R = SSchemistry.chemical_reagents_list[reagent]
	C.setLabel(R.name)

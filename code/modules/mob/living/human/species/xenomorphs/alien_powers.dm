/proc/alien_queen_exists(var/ignore_self,var/mob/living/human/self)
	for(var/mob/living/human/Q in living_mob_list)
...
/mob/living/human/proc/gain_plasma(var/amount)
...
/mob/living/human/proc/check_alien_ability(var/cost,var/needs_foundation,var/needs_organ)	//Returns 1 if the ability is clear for usage.
...
// Free abilities.
/mob/living/human/proc/transfer_plasma(mob/living/human/M as mob in oview())
...
/mob/living/human/proc/lay_egg()
	...
	if(!config.aliens_allowed)
		...
		verbs -= /mob/living/human/proc/lay_egg
		return
...
/mob/living/human/proc/Spit(var/atom/A)
...
/mob/living/human/proc/corrosive_acid(O as obj|turf in oview(1)) //If they right click to corrode, an error will flash if its an invalid target./N
...
/mob/living/human/proc/resin() // -- TLE

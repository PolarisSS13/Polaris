...
/datum/species/shapeshifter/promethean/avatar
	...
	valid_transform_species = list(SPECIES_HUMAN, SPECIES_HUMAN_VATBORN, SPECIES_UNATHI, SPECIES_TAJ, SPECIES_SKRELL, SPECIES_DIONA, SPECIES_ , SPECIES_VOX, SPECIES_MONKEY, SPECIES_SKELETON)

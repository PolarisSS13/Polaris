...
/datum/species/shapeshifter/replicant
	...
	valid_transform_species = list(SPECIES_HUMAN, SPECIES_HUMAN_VATBORN, SPECIES_UNATHI, SPECIES_TAJ, SPECIES_SKRELL, SPECIES_DIONA, SPECIES_ , SPECIES_MONKEY, SPECIES_VOX)

...
/mob/living/carbon/nymph/proc/merge()
	...
	if(istype(src.loc,/mob/living/carbon))
		src.verbs -= /mob/living/carbon/nymph/proc/merge
		return
...
/mob/living/carbon/nymph/proc/do_merge(var/mob/living/carbon/human/H)
	...
	loc = H
	verbs += /mob/living/carbon/nymph/proc/split
	verbs -= /mob/living/carbon/nymph/proc/merge
	return TRUE


/mob/living/carbon/nymph/proc/split()
	set category = "Abilities"
	...
	if(!(istype(src.loc,/mob/living/carbon)))
		src.verbs -= /mob/living/carbon/nymph/proc/split
		return

...
/obj/item/mmi/digital/transfer_identity(var/mob/living/human/H)
	brainmob.dna = H.dna
...
/obj/item/mmi/digital/robot/transfer_identity(var/mob/living/human/H)
	..()
	if(brainmob.mind)
...
/obj/item/mmi/digital/posibrain/transfer_identity(var/mob/living/human/H)
	..()
	if(brainmob.mind)

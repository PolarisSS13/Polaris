...
/mob/living/simple_animal/borer/verb/secrete_chemicals()
	...
	var/chem = input("Select a chemical to secrete.", "Chemicals") as null|anything in list(/datum/reagent/alkysine, /datum/reagent/bicaridine,
																							/datum/reagent/hyperzine, /datum/reagent/tramadol)

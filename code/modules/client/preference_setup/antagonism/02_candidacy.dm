...
// TODO: Update to new antagonist system.
	"traitor" = 1,//IS_MODE_COMPILED("traitor"),             // 0
	"operative" = 1,//IS_MODE_COMPILED("nuclear"),           // 1
	"changeling" = 1,//IS_MODE_COMPILED("changeling"),       // 2
	"wizard" = 1,//IS_MODE_COMPILED("wizard"),               // 3
	"malf AI" = 1,//IS_MODE_COMPILED("malfunction"),         // 4
	"revolutionary" = 1,//IS_MODE_COMPILED("revolution"),    // 5
	"alien candidate" = 1, //always show                 	 // 6
	"positronic brain" = 1,                             	 // 7
	"cultist" = 1,//IS_MODE_COMPILED("cult"),                // 8
	"renegade" = 1,                                     	 // 9
	"ninja" = "true",                                   	 // 10
	"raider" = 1,//IS_MODE_COMPILED("heist"),                // 11
	"diona" = 1,                                         	 // 12
	"loyalist" = 1,//IS_MODE_COMPILED("revolution"),         // 13
	"pAI candidate" = 1, // -- TLE                       	 // 14
	"zombie" = 1,//IS_MODE_COMPILED("zombie"),      		 // 15
)

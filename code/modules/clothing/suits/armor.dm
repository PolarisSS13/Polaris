...
/obj/item/clothing/suit/armor/heavy
	...
	desc = "An old military-grade suit of armor. Incredibly robust against brute force damage! However, it offers little protection from energy-based weapons, which, combined with its bulk, makes it mostly obsolete."
	icon_state = "heavy"
	item_state = "swat_suit"
	w_class = 4 // bulky item
	...
	slowdown = 6 // If you're built like a tank, you're gonna move like a tank.
	flags_inv = HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT
	siemens_coefficient = 0

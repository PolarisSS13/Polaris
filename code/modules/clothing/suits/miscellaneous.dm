...
/obj/item/clothing/suit/costume/syndicatefake
	...
	desc = "A plastic replica of a mercenary combat space suit, you'll look just like a real murderous mercenary agent in this! This is a toy, it is not made for use in space!"

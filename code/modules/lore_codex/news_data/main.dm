/datum/lore/codex/category/main_news // The top-level categories for the news thing
	...
	children = list(
		/datum/lore/codex/page/article129,
		/datum/lore/codex/page/article128,
		/datum/lore/codex/page/article127,
		/datum/lore/codex/page/article126,
		/datum/lore/codex/page/article125,
		/datum/lore/codex/page/article124,
		/datum/lore/codex/page/article123,
		/datum/lore/codex/page/article122,
		/datum/lore/codex/page/article121,
		/datum/lore/codex/page/article120,
		/datum/lore/codex/page/article119,
		/datum/lore/codex/page/article118,
...
/datum/lore/codex/page/article6
	...
	* Icarus Front chairperson Mackenzie West has proposed a moratorium on the creation of new prometheans for the duration of the crisis.\
	<br><br>* Local laws on the subject will apply until the Assembly meets late in May.\
	<br><br>\
...
/datum/lore/codex/page/article84
	...
	<br><br>\
	Meanwhile as Far Kingdoms vessels enter the Whythe system, the Solar Fleet has ceased bombardment of the Whythe Superweapon, handing off 'suppression' of the weapon to skrell forces."
...
/datum/lore/codex/page/article86
	...
	<br><br>\
	Other stations with significant permanent populations have been paralyzed by local inaction and the disloyalty of local police and security forces to the Far Kingdoms skrell, and several with no Skrellian presence have issued statements that they will not be accepting any military presence from the Far Kingdoms. It is unclear at this point if this represents the beginning of another major conflict within the system."
...
/datum/lore/codex/page/article118
	name = "02/19/75 - Cynosure Bulletin: Winner of Site Union Representative Announced"
	data = "We are pleased to announce that after a three week introductory campaigning period, the first winner of Cynosure Station's Site Union Representative position has been determined. \
	<br><br>\
	...
	<br><br>\
	We thank you for the large voter turnout, with the vast majority of eligible (non-managerial) staff having cast their votes to make this historic decision, we hope that the representative role serves our valued staff, contractors and authorised visitors well."

/datum/lore/codex/page/article119
	name = "03/10/75 - Spectacular Fireworks Expected As SifGuard Scuttles Vox Derelict"
	data = "Public relations officials working with SifGuard have released a post-operation report and an advisory that spectacular light shows can be expected across the sky above Kalmar, Londuneyja, Amundsen, and portions of Skargard and Kaltsandur, over the next twenty-four hours. This follows the successful scuttling and disintegration of a derelict vox vessel that was detected on a collision course with populated areas of Amundsen.\
	<br><br>\
	\"It was a very large vessel, one of the largest we've seen in this stellar region.\" said Captain Thorni Hjelmarvilli, who oversaw the boarding action and subsequent demolition. \"We expected resistance, or a need for an evacuation effort, but the vessel was completely abandoned when we arrived.\"\
	Captain Hjelmarvilli added, \"The initial sweep suggested magmellite, so we were ready for a bug hunt, but in the end it was a simple in and out operation.\"\
	<br><br>\
...
/datum/lore/codex/page/article120
	...
	<br><br>\
	Mr. Kindler has thanked the SifGuard, Hedberg-Hammarstrom corporation, and the people of Drammen for their close cooperation with the company. Cynosure Station management declined to comment."

/datum/lore/codex/page/article121
	name = "07/05/75 - Naval Assets Scramble As Raphael Besieged By Vox Warfleet"
	data = "In a shocking turn of events, the Raphael system has found itself under immediate and severe threat by a previously unknown vox raiding fleet of unprecedented size.\
	<br><br>\
...
/datum/lore/codex/page/article122
	...
	<br><br>\
	\[This publication is a partial retraction of our previously report on the Raphael crisis. Oculum regrets any discrepancies but accepts no legal liability for actions undertaken on the basis of those discrepancies.\]"

/datum/lore/codex/page/article123
	name = "07/07/75 - Notorious Pirate King Arrested Amid Raphael Vox Crisis"
	data = "The crisis at Raphel continues to develop after a tense 24 hours of closed-door discussions between the corporate triumvirate council, the Frontier Terminus naval command, and the vox fleet that has been occupying the system for the past two standard days. After hours of standoffs, negotiations appeared to break down at approximately 16:50 on the 6th, resulting in a single vox capital ship powering engines and beginning an apparently suicidal combat approach towards the habitat.\
	<br><br>\
...
/datum/lore/codex/page/article124
	...
	<br><br>\
	Vystholm pirates operating out of Eutopia been of growing concern in the region and are believed in operate numerous deep-space staging points in the area between Eutopia and Gavel. The Golden Crescent Alliance Bloc has committed much of its forces to anti-piracy efforts within its jurisdiction, but the number of successful raids on shipping are on the rise. No ransom demand has yet been made for the missing crew members, and concerns have been raised about the difficulty of recovery if any are sold into the growing Eutopian slave trade."

/datum/lore/codex/page/article125
	name = "07/10/75 - Vox Crisis At Raphael Transitions Into Support Agreement"
	data = "With the lifting of the information quarantine, new information from Raphael has been released.\
	<br><br>\
...
/datum/lore/codex/page/article126
	...
	<br><br>\
	Admiral Slimani also confirmed that \"An armed precision strike is not currently on the table due to the immense risks involved in extraterritorial operations.\" but committed a personal donation of 5,000 thalers to a fundraiser begun by the Tahana family to pursue ransom or private security options. No public statement has yet been made by the Hegemony regarding their up to seventy-four missing citizens, but negotiations are ongoing."

/datum/lore/codex/page/article127
	name = "07/30/75 - Hegemony Fleet Underway To Eutopia"
	data = "Following the recent news regarding the raid on a unathi scientific exchange vessel by Vystholm pirates and subsequent diplomatic negotiations with SolGov, a press conference has been broadcast by the Moghes Hegemony.\
	<br><br>\
...
/datum/lore/codex/page/article129
	...
	<br><br>\
	The Gavel Defense Force is reportedly unconcerned by the development, but are expected to remain on high alert for the next several months as the Hegemony fleet approaches. The Hegemony embassy on Luna was not available for comment."

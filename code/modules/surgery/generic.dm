...
/datum/surgery_step/generic/cut_with_laser
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message("[user] starts the bloodless incision on [target]'s [affected.name] with \the [tool].</font>", \
		"You start the bloodless incision on [target]'s [affected.name] with \the [tool].</font>")
...
/datum/surgery_step/generic/incision_manager
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message("[user] starts to construct a prepared incision on and within [target]'s [affected.name] with \the [tool].</font>", \
		"You start to construct a prepared incision on and within [target]'s [affected.name] with \the [tool].</font>")
...
/datum/surgery_step/generic/cut_open
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message("[user] starts the incision on [target]'s [affected.name] with \the [tool].</font>", \
		"You start the incision on [target]'s [affected.name] with \the [tool].</font>")
...
/datum/surgery_step/generic/clamp_bleeders
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message("[user] starts clamping bleeders in [target]'s [affected.name] with \the [tool].</font>", \
		"You start clamping bleeders in [target]'s [affected.name] with \the [tool].</font>")
...
/datum/surgery_step/generic/retract_skin
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		var/self_msg = "You start to pry open the incision on [target]'s [affected.name] with \the [tool].</font>"
		if (target_zone == BP_TORSO)
			msg = "[user] starts to separate the ribcage and rearrange the organs in [target]'s torso with \the [tool].</font>"
			self_msg = "You start to separate the ribcage and rearrange the organs in [target]'s torso with \the [tool].</font>"
		if (target_zone == BP_GROIN)
			msg = "[user] starts to pry open the incision and rearrange the organs in [target]'s lower abdomen with \the [tool].</font>"
			self_msg = "You start to pry open the incision and rearrange the organs in [target]'s lower abdomen with \the [tool].</font>"
...
/datum/surgery_step/generic/cauterize
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message("[user] is beginning to cauterize the incision on [target]'s [affected.name] with \the [tool].</font>" , \
		"You are beginning to cauterize the incision on [target]'s [affected.name] with \the [tool].</font>")
...
/datum/surgery_step/generic/amputate
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message("[user] is beginning to amputate [target]'s [affected.name] with \the [tool].</font>" , \
		"You are beginning to cut through [target]'s [affected.amputation_point] with \the [tool].</font>")

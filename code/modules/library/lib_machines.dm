	...
	switch(screenstate)
		if(0)
			...
			if(src.arcanecheckout)
				...
				user.visible_message("<span class='notice'>\The [user] stares at the blank screen for a few moments, [TU.his] expression frozen in fear. When [T.he] finally awakens from it, [T.he] looks a lot older.</span>", 2)

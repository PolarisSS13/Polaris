...
/obj/item/device/kit/accessory 
	name = "accessory modification kit"
	desc = "A kit for modifying accessories."

/obj/item/device/kit/accessory/can_customize(var/obj/item/I)
	return istype(I, /obj/item/clothing/accessory/poncho)

/obj/item/device/kit/accessory/customize(var/obj/item/I, var/mob/user)
	if(can_customize(I))

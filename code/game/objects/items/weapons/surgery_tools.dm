...
/obj/item/weapon/retractor
	...
	matter = list(MATERIAL_STEEL = 2500, MATERIAL_GLASS = 1500)
	flags = CONDUCT
	w_class = 2.0
...
/obj/item/weapon/hemostat
	...
	icon = 'icons/obj/surgery.dmi'
	icon_state = "hemostat"
	matter = list(MATERIAL_STEEL = 1200, MATERIAL_GLASS = 1000)
	flags = CONDUCT
	w_class = 2.0
	origin_tech = list(TECH_MATERIAL = 1, TECH_BIO = 1)
...
/obj/item/weapon/surgicaldrill
	...
	matter = list(MATERIAL_STEEL = 3500, MATERIAL_GLASS = 2500)
	flags = CONDUCT
	force = 15.0
	w_class = 3
	origin_tech = list(TECH_MATERIAL = 1, TECH_BIO = 1)
...
/obj/item/weapon/scalpel
	...
	throw_range = 5
	origin_tech = list(TECH_MATERIAL = 1, TECH_BIO = 1)
	matter = list(MATERIAL_STEEL = 2500, MATERIAL_GLASS = 1200)

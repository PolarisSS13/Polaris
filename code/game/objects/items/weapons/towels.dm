...
/obj/item/weapon/towel/equipped(var/M, var/slot)
	...
	switch(slot)
		if(slot_head)
			sprite_sheets = list(SPECIES_  = 'icons/mob/species/ /head.dmi')
		if(slot_wear_suit)
			sprite_sheets = list(SPECIES_  = 'icons/mob/species/ /suit.dmi')
		if(slot_belt)
			sprite_sheets = list(SPECIES_  = 'icons/mob/species/ /belt.dmi')

...
/obj/effect/temp_visual/item_pickup_ghost/proc/assumeform(var/obj/item/picked_up)
	icon = picked_up.icon
...
/obj/effect/temp_visual/item_pickup_ghost/proc/animate_towards(var/atom/target)

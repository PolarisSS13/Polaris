...
/obj/item/poster/wanted/New(mapload, icon/person_icon, wanted_name, description)
...
/obj/structure/sign/poster/wanted/New(mapload, icon/person_icon, person_name, description)
	. = ..()
	if(!person_icon)

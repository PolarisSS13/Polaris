...
/obj/random/maintenance/clean/item_to_spawn()
	return pick(prob(10);/obj/random/contraband,
				...
				prob(3);/obj/item/clothing/suit/storage/hooded/toggle/hoodie/black,
				prob(3);/obj/item/clothing/suit/storage/hooded/toggle/hoodie/blue,
				prob(3);/obj/item/clothing/suit/storage/hooded/toggle/hoodie/red,
				prob(3);/obj/item/clothing/suit/storage/hooded/toggle/hoodie/yellow,

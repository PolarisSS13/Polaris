...
/obj/machinery/computer/communications/Topic(href, href_list)
	...
	if (using_map && !(src.z in using_map.contact_levels))
		usr << "<font color='red'> <b>Unable to establish a connection</b>: \black You're too far away from the station!</font>"
		return
	usr.set_machine(src)
...
/obj/machinery/computer/communications/attack_hand(var/mob/user as mob)
	if(..())
		return
	if (using_map && !(src.z in using_map.contact_levels))
		user << "<font color='red'> <b>Unable to establish a connection</b>: \black You're too far away from the station!</font>"
		return

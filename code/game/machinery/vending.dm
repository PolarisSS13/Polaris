...
/obj/machinery/vending/crittercare//Paradise port.
	...
	products = list(/obj/item/storage/firstaid/aquatic_kit/full =5, /obj/item/fish_eggs/goldfish = 5,
	...
	prices = list(/obj/item/storage/firstaid/aquatic_kit/full = 60, /obj/item/fish_eggs/goldfish = 10,

...
/obj/machinery/vending/sovietsoda
	...
	products = list(/obj/item/weapon/reagent_containers/food/drinks/cans/boda = 30,		//ADDITION 03/01/2021
					/obj/item/weapon/reagent_containers/food/drinks/cans/kompot = 20)	//ADDITION 03/01/2021
	contraband = list(/obj/item/weapon/reagent_containers/food/drinks/cans/kvass = 20) 	//ADDITION 03/01/2021
	idle_power_usage = 211 //refrigerator - believe it or not, this is actually the average power consumption of a refrigerated vending machine according to NRCan.
	vending_sound = "machines/vending/vending_cans.ogg"

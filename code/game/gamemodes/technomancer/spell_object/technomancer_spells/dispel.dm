...
/datum/spell_metadata/dispel/get_spell_info()
	var/obj/item/weapon/spell/technomancer/dispel/spell = spell_path
	. = list()
	.["Energy Cost"] = initial(spell.dispel_energy_cost)
	.["Instability Cost"] = initial(spell.dispel_instability_cost)
...
/obj/item/weapon/spell/technomancer/dispel
	...
	var/dispel_energy_cost = 500
	var/dispel_instability_cost = 5

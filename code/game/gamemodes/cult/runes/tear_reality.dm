/obj/effect/newrune/tear_reality
...
/obj/effect/newrune/tear_reality/can_invoke(mob/living/invoker)
	if (narsie_cometh)
		to_chat(invoker, SPAN_WARNING("The Geometer has already been called forth."))
		return
	return TRUE

/obj/effect/newrune/tear_reality/invoke(list/invokers)
...
/obj/effect/newrune/tear_reality/proc/call_shuttle()

/obj/effect/rune/hide_runes
	...
	talisman_path = /obj/item/paper/talisman/hide_runes
	circle_words = list(CULT_WORD_HIDE, CULT_WORD_SEE, CULT_WORD_BLOOD)
	invocation = "Kla'atu barada nikt'o!"

/obj/effect/rune/hide_runes/invoke(list/invokers)
	var/mob/living/L = invokers[1]
	for (var/obj/effect/rune/R in range(4, src))
...
/obj/effect/rune/reveal_runes/invoke(list/invokers)
	var/mob/living/L = invokers[1]
	for (var/obj/effect/rune/R in range(4, src))
		if (R.invisibility == SEE_INVISIBLE_CULT)
			R.invisibility = 0

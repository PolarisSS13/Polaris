/obj/item/paper/newtalisman/hide_runes
...
/obj/item/paper/newtalisman/hide_runes/invoke(mob/living/user)
	for (var/obj/effect/newrune/R in range(2, user))
...
/obj/item/paper/newtalisman/reveal_runes
	talisman_name = "Reveal Runes"
	talisman_desc = "Reveal all nearby hidden runes."
	invocation = "Nikt'o barada kla'atu!"

/obj/item/paper/newtalisman/reveal_runes/invoke(mob/living/user)
	for (var/obj/effect/newrune/R in range(2, user))
		if (R.invisibility == SEE_INVISIBLE_CULT)
			R.invisibility = 0
			R.alpha = 255

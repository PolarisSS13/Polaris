...
//			src.visibility=1
	...
	if(word1 == cultwords["join"] && word2 == cultwords["hide"] && word3 == cultwords["technology"])
		return runestun()
	if(word1 == cultwords["technology"] && word2 == cultwords["join"] && word3 == cultwords["self"])
...
/obj/item/weapon/book/tome
	...
	tomedat = {"<html>
				...
				<h3>Burning blood</h3>
				This rune ignites all runes, and pools of blood, with DNA matching the scribed rune. The damage is variable, dependant on the amount of matching blood in range of any individual. You need 5 cultists invoking the rune for it to work. This rune is unreliable and may cause unpredicted effect when invoked. It also drains significant amount of your health when succesfully invoked.<br>
				<h3>Communicate</h3>
...
/obj/item/weapon/book/tome/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W, /obj/item/stack/material) && do_after(user, 3 SECONDS, src))
		var/obj/item/stack/material/M = W

		M.use(1)
		new /obj/item/weapon/material/kitchen/utensil/fork/tuning(get_turf(user), M.material.name)

		to_chat(user, "<span class='notice'>Using the diagrams in the tome, you create an alchemical tuning fork.</span>")
		return

#define METEOR_WAVE_DELAY		625 //minimum wait between waves in tenths of seconds
...
GLOBAL_LIST_INIT(meteors_threatening, list(/obj/effect/meteor/medium=5, /obj/effect/meteor/big=10, \

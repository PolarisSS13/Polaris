...
/obj/item/mecha_parts/mecha_equipment/tool/powertool/inflatables/get_equip_info()
	...
	&nbsp; - Doors left: <span style=\"color:#00f;\">[my_deployer.stored_doors]</span>/[my_deployer.max_doors]<br>\
	&nbsp; - Walls left: <span style=\"color:#00f;\">[my_deployer.stored_walls]</span>/[my_deployer.max_walls]"

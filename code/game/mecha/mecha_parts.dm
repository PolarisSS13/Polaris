...
/obj/item/mecha_parts/part/phazon_torso
	name="Phazon Torso"
	desc = "Your scientists were so preoccupied with whether or not they could, they didn't stop to think if they should."
	icon_state = "phazon_harness"
	origin_tech = list(TECH_PHORON = 6, TECH_MATERIAL = 7, TECH_BLUESPACE = 6, TECH_POWER = 7)

/obj/item/mecha_parts/part/phazon_head
	name="Phazon Head"
	icon_state = "phazon_head"
	origin_tech = list(TECH_PHORON = 5, TECH_MATERIAL = 5, TECH_MAGNET = 8, TECH_ENGINEERING = 8)

...
/datum/antagonist/ert
	...
	role_text = "Emergency Response Operator"
	role_text_plural = "Emergency Responders"
	welcome_text = "As member of the Emergency Response Team, you answer only to your leader and company officials."
	leader_welcome_text = "As the leader of the Emergency Response Team, you answer only to the Company, and have authority to override the Captain where it is necessary to achieve your mission goals. It is recommended that you attempt to cooperate with the captain where possible, however."
...
/datum/antagonist/ert/greet(var/datum/mind/player)
	if(!..())
		return
	player.current << "The Emergency Response Team works for Asset Protection; your job is to protect [company_name]'s personnel and assets. There is an emergency on the [station_name()], you are tasked to go and fix the problem."

...
/datum/antagonist/ert
	...
	leader_welcome_text = "As leader of the Emergency Response Team, you answer only to the Company, and have authority to override the Captain where it is necessary to achieve your mission goals. It is recommended that you attempt to cooperate with the crew where possible, however."
...
/datum/antagonist/ert/greet(var/datum/mind/player)
	if(!..())
		return
	player.current << "The Emergency Response Team works for Asset Protection; your job is to protect [company_name]'s personnel and ass-ets. There is an emergency on the [station_name()], you are tasked to go and fix the problem."

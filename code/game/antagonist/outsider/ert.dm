...
/datum/antagonist/ert
	...
	leader_welcome_text = "As leader of the Emergency Response Team, you answer only to the President, and have authority to override the orders of local officials where it is necessary to achieve your mission goals. It is recommended that you attempt to cooperate with the Colony Director where possible, however."

...
/datum/job/qm
	...
	banned_job_species = list(SPECIES_VOX, SPECIES_MANTID, "digital")
...
/datum/job/lawyer
	...
	banned_job_species = list(SPECIES_VOX, SPECIES_MANTID, SPECIES_PROMETHEAN, SPECIES_UNATHI, SPECIES_DIONA, SPECIES_TESHARI, SPECIES_ZADDAT, "digital")

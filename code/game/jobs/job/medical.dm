...
/datum/job/cmo
	...
	banned_job_species = list(SPECIES_VOX, SPECIES_MANTID, SPECIES_TESHARI, SPECIES_DIONA, SPECIES_PROMETHEAN, SPECIES_ZADDAT, "digital")
...
/datum/job/psychiatrist
	...
	banned_job_species = list(SPECIES_VOX, SPECIES_MANTID, SPECIES_PROMETHEAN, SPECIES_DIONA)
...
/datum/job/paramedic
	...
	banned_job_species = list(SPECIES_VOX, SPECIES_MANTID, SPECIES_DIONA)

...
/datum/job/chemist
	...
	supervisors = "the chief medical officer"
	selection_color = "#ffeef0"
	access = list(access_medical, access_medical_equip, access_morgue, access_chemistry, access_virology, access_maint_tunnels)
...
/datum/job/geneticist
	...
	selection_color = "#ffeef0"
	access = list(access_medical, access_morgue, access_medical_equip, access_genetics, access_research, access_maint_tunnels)
...
/datum/job/Paramedic
	...
	supervisors = "the chief medical officer"
	selection_color = "#ffeef0"
	access = list(access_medical, access_medical_equip, access_morgue, access_surgery, access_virology, access_eva, access_maint_tunnels, access_external_airlocks)

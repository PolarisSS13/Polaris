...
/datum/job/cmo
	...
	skills = list(/datum/new_skill/logistics, /datum/new_skill/corporate_law, /datum/new_skill/management, /datum/new_skill/medicine, /datum/new_skill/anatomy = 2, /datum/new_skill/chemistry, /datum/new_skill/first_aid, /datum/new_skill/virology)
...
/datum/job/doctor
	...
	skills = list(/datum/new_skill/medicine, /datum/new_skill/anatomy, /datum/new_skill/first_aid)
...
/datum/job/chemist
	...
	skills = list(/datum/new_skill/medicine, /datum/new_skill/chemistry, /datum/new_skill/first_aid)
...
/datum/job/psychiatrist
	...
	skills = list(/datum/new_skill/psychology)

...
/datum/job/hop
	...
	minimum_character_age = 25
	min_age_by_species = list(SPECIES_UNATHI = 70, SPECIES_  = 20, "mechanical" = 10, SPECIES_HUMAN_VATBORN = 14)
	ideal_character_age = 50
	ideal_age_by_species = list(SPECIES_UNATHI = 140, SPECIES_  = 27, "mechanical" = 20, SPECIES_HUMAN_VATBORN = 20)

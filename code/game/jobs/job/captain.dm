...
/datum/job/captain
	...
	skills = list(/datum/new_skill/logistics, /datum/new_skill/corporate_law, /datum/new_skill/management, /datum/new_skill/science)
...
/datum/job/secretary
	...
	skills = list(/datum/new_skill/logistics, /datum/new_skill/corporate_law)

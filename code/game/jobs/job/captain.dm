...
/datum/job/captain
	...
	banned_job_species = list(SPECIES_UNATHI, SPECIES_TAJ, SPECIES_TESHARI, SPECIES_DIONA, SPECIES_PROMETHEAN, SPECIES_ZADDAT, SPECIES_VOX, SPECIES_MANTID, "mechanical", "digital")
...
/datum/job/hop
	...
	banned_job_species = list(SPECIES_PROMETHEAN, SPECIES_ZADDAT, SPECIES_VOX, SPECIES_MANTID, "digital", SPECIES_DIONA)

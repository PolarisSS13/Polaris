...
/datum/job/hos
	...
	skills = list(/datum/new_skill/logistics, /datum/new_skill/corporate_law, /datum/new_skill/management, /datum/new_skill/combat, /datum/new_skill/cqc, /datum/new_skill/weapons_expertise)
...
/datum/job/detective
	...
	skills = list(/datum/new_skill/logistics, /datum/new_skill/corporate_law, /datum/new_skill/forensics, /datum/new_skill/combat, /datum/new_skill/weapons_expertise)
...
/datum/job/officer
	...
	skills = list(/datum/new_skill/logistics, /datum/new_skill/corporate_law, /datum/new_skill/combat, /datum/new_skill/cqc, /datum/new_skill/weapons_expertise)

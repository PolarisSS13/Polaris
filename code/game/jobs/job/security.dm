...
/datum/job/hos
	...
	banned_job_species = list(SPECIES_ , SPECIES_DIONA, SPECIES_PROMETHEAN, SPECIES_ZADDAT, "digital", SPECIES_UNATHI, "mechanical")
...
/datum/job/warden
	...
	banned_job_species = list(SPECIES_ZADDAT, SPECIES_ , SPECIES_DIONA)

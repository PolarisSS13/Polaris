...
/datum/job/hos
	...
	banned_job_species = list(SPECIES_VOX, SPECIES_MANTID, SPECIES_TESHARI, SPECIES_DIONA, SPECIES_PROMETHEAN, SPECIES_ZADDAT, "digital", SPECIES_UNATHI, "mechanical")
...
/datum/job/warden
	...
	banned_job_species = list(SPECIES_VOX, SPECIES_MANTID, SPECIES_ZADDAT, SPECIES_TESHARI, SPECIES_DIONA)
...
/datum/job/detective
	...
	banned_job_species = list(SPECIES_VOX, SPECIES_MANTID, SPECIES_ZADDAT, SPECIES_DIONA)

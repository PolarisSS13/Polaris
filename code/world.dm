...
/world/proc/update_status()
	...
	s += "<b>The World Server - Redux!</b> (BUG TESTING) Current map: <b>[station_name()]</b>";
	s += " - Like SS13, but <i>spaceless</i>. <b>High MRP/Low HRP.</b> ("
...
//	s += "[game_version]"
	...
	if (config && config.hostedby)
		features += "hosted by the <b>[config.hostedby]</b>"
